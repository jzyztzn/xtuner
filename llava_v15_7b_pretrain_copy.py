...
# llm_name_or_path = '/root/autodl-tmp/tzn/Projects/pretrained/qwen/Qwen1___5-0___5B'
visual_encoder_name_or_path = '/root/autodl-tmp/tzn/Projects/pretrained/clip/clip-vit-large-patch14-336'
# visual_encoder_name_or_path = '/root/autodl-tmp/tzn/Projects/pretrained/clip/clip-vit-base-patch32'
# visual_encoder_name_or_path = '/root/autodl-tmp/tzn/Projects/pretrained/AI-ModelScope/vit-base-patch16-224'
...
# max_length = int(2048 - (224 / 32)**2)
# max_length = int(2048 - (224 / 16)**2)
...
visualizer = dict(
  type=Visualizer,
  vis_backends=[
      dict(type=WandbVisBackend, init_kwargs=dict(project=wandb_name))])
